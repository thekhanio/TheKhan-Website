...
const steveReport: ReportConfig = {
  ...
  currentMonth: {
    ...
    headlineMetrics: [
      { value: "40", label: "customer leads" },
      { value: "$72", label: "average cost per lead from ads" },
    ...
    leadTransparency: {
      ...
      math: {
        rows: [
          ...
          { operator: "+", value: 4, label: "Google Ads phone-call leads" },
          { operator: "+", value: 4, label: "LSA leads" },
    ...
    leadSources: [
      ...
      {
        label: "Search Ads",
        detail: "Google Ads — Paver · 8 forms + 4 phone calls",
        count: 12,
        type: "paid",
      },
      {
        label: "LSA Ads",
        detail: "Local Service Ads — Power Washing",
        count: 4,
        type: "paid",
      },
      {
        label: "C&G",
        detail: "TheKhan lead gen tool",
        count: 5,
        type: "forwarded",
      },
    ],
    ...
    adsCampaigns: [
      {
        name: "Google Ads — Paver Restoration",
        spend: "$1,030",
        leads: 12,
        cpl: "$85 / lead",
        status: "active",
        detail: "8 form leads + 4 phone calls = 12 paver leads.",
      },
      {
        name: "LSA — Power Washing",
        spend: "$129",
        leads: 4,
        cpl: "$32 / lead",
        status: "active",
        detail:
          "Pay-per-lead — only charged when a real customer connects. Half the cost of Google Ads paver leads.",
        note: "The most efficient ad channel running.",
      },
      {
        name: "Google Ads — Power Washing",
        spend: "$153",
        leads: 0,
        cpl: "—",
        status: "paused",
        detail:
          "$153 spent. 0 leads. Paused mid-April once LSA proved it could deliver power washing leads at half the cost.",
