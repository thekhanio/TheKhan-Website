...
const marioConfig: ProposalConfig = {
  ...
  whatWellBuild: [
    ...
    { title: "Google Business Profile (40+ reviews as the goal)", why: "I migrate your C&G profile over 4 weeks \u2014 new name, same reviews, same trust. Then we reach out to your snow removal clients to push you past 40 before the season starts. You launch with proof most businesses take years to build." },
    { title: "Tracking \u2014 see where every call comes from", why: "I set up analytics so you can see who visits your site, what they searched, and where they came from. No guessing." },
  ...
  whatHappensNext: [
    ...
    { step: "Google Business Profile migration starts", detail: "Week by week, I move C&G to MarioScape. New name, same 38+ reviews. By the end, you\u2019re fully rebranded." },
